...
pub static PROVIDERS: &[ProviderMeta] = &[
    ...
    ProviderMeta { provider: ApiProvider::MiniMax,    name: "minimax",    display_name: "MiniMax",     base_url: "https://api.minimaxi.com/anthropic",                      env_vars: &["MINIMAX_API_KEY"],                 default_model: "MiniMax-M2.7",             protocol: ApiProtocol::Anthropic,       local: false },
